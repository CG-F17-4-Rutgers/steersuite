...
ifeq ($(config),debug)
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L. -L../lib -stdlib=libc++ -Wl,-rpath,/Users/kianjackson/Documents/ComputerGraphics/A2/steersuite/build/lib -install_name @rpath/libDebugUtils.dylib
