...
ifeq ($(config),debug)
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L. -L../lib -dynamiclib -stdlib=libc++ -Wl,-rpath,/Users/Taichi/Desktop/steersuite-rutgers-master/build/lib -install_name @rpath/libsteerlib.dylib
